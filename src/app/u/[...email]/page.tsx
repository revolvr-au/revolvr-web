...
export default async function ProfilePage({
  ...
  const { email: emailParts } = await params;

  // ✅ catch-all param is string[]
  const raw = Array.isArray(emailParts) ? emailParts.join("/") : String(emailParts ?? "");

  // ✅ first segment is your encoded email like "revolvr.au%40gmail.com"
