...
export default function AgeVerificationPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      } else if (data.status === 'UNDERAGE_LOCKED') {
  ...
  return (
    <main className="max-w-md mx-auto mt-10 px-4">
      ...
      <p className="mb-2">
        Revolvr is only available to people aged 16 or older.
        Please confirm your date of birth and that you are at least 16 years of age.
      </p>
      <p className="text-sm text-gray-500 mb-4">
        To comply with Australian online safety laws, Revolvr is restricted to people aged 16 or older in Australia.
        Revolvr may request additional age verification in the future.
      </p>
